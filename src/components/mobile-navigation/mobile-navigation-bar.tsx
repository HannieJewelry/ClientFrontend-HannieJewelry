...
const list = [
  ...
  { title: "Danh mục", Icon: CategoryOutlined, href: "/mobile-category-nav" },
  { title: "Giỏ hàng", Icon: ShoppingBagOutlined, href: "/shopping_cart" },
  { title: "Tài khoản", Icon: User2, href: "/profile" }
];
